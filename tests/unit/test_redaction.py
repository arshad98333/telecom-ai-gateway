...
from telecom_middleware.observability.redaction import (
    REDACTED,
    REMOVED,
    Redactor,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "card_number",
        "private_key",
        # The stored passcode hash and the database connection string are unique to this
        # service, and neither belongs in a log line.
        "hash",
        "mongodb_uri",
    ],
)
